...
@section('content')
    <div class="flex justify-center ">
        ...
        <div class="w-8/12 bg-white p-6 rounded-lg">
            @auth
                <form action="{{route('posts')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="title" id="title"   class="bg-gray-100 border-2 w-full p-2 rounde-lg mb-4 @error('desc') border-red-500 @enderror" placeholder="write the title....." />

                        <label for="desc" class="sr-only">Hashtag:</label>
                        <input type="text" name="hashtag" id="hashtag"   class="bg-gray-100 border-2 w-full p-2 rounde-lg mb-4 @error('desc') border-red-500 @enderror" placeholder="write #hashtags..." />
                        ...
                        <textarea name="desc" id="desc" cols="30" rows="7" class="bg-gray-100 border-2 w-full p-3 rounde-lg @error('desc') border-red-500 @enderror" placeholder="write description....." ></textarea>
           ...
           @if ($posts->count())
           <h1 class="text-4xl text-center tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
